"""
train_sft_v2.py — SFT Training for Chess Reasoning Model
===============================================================
Trains on the clean V2 dataset with:
  - Qwen2.5-7B-Instruct (4-bit) via Unsloth + LoRA
  - Loss masking on system/user turns (train_on_responses_only)
  - Cosine LR scheduler, gentler hyperparameters than V1

If 7B OOMs, change MODEL_NAME to the 3B variant and BATCH_SIZE to 2.
"""
...
class Config:
    ...
    BATCH_SIZE = 1          # 1 for 7B (VRAM constrained), 2 for 3B
